function EmeraldNormal() {
  return `
    ...
    <path d="M154.31 56.4557C154.32 56.3869 154.322 56.3199 154.328 56.2507C154.4 55.523 155.624 51.1274 174.785 51.1274C194.296 51.1274 195.584 55.6855 195.668 56.287C195.675 56.331 195.678 56.3743 195.684 56.4183L201.374 94.989C201.411 95.2383 201.344 95.489 201.167 95.6681C199.834 97.0153 193.192 102.625 175 102.625C156.807 102.625 150.165 97.0153 148.832 95.6681C148.655 95.489 148.588 95.2383 148.625 94.989L154.31 56.4557Z" fill="url(#paint5_linear_765_92142)"/>
    <defs>
      <filter id="filter0_f_765_92142" x="120.313" y="209.721" width="106.453" height="118.945" filterUnits="userSpaceOnUse" color-interpolation-filters="sRGB">
        ...
        <feGaussianBlur stdDeviation="1.13932" result="effect1_foregroundBlur_765_92142"/>
      </filter>
      <filter id="filter1_df_765_92142" x="71.5498" y="203.797" width="179.102" height="72.9167" filterUnits="userSpaceOnUse" color-interpolation-filters="sRGB">
        <feFlood flood-opacity="0" result="BackgroundImageFix"/>
        ...
        <feGaussianBlur stdDeviation="0.455729" result="effect2_foregroundBlur_765_92142"/>
      </filter>
      ...
      <radialGradient id="paint3_radial_765_92142" cx="0" cy="0" r="1" gradientUnits="userSpaceOnUse" gradientTransform="translate(122.541 266.347) rotate(79.4004) scale(83.3383 37.0268)">
        <stop stop-color="#F2F2F2"/>
        <stop offset="0.0001" stop-color="#F2F2F2"/>
        <stop offset="1" stop-color="#F2F2F2" stop-opacity="0"/>
      </radialGradient>
      <radialGradient id="paint4_radial_765_92142" cx="0" cy="0" r="1" gradientUnits="userSpaceOnUse" gradientTransform="translate(137.124 270.448) rotate(79.4004) scale(83.3383 37.0268)">
        <stop stop-color="#F2F2F2"/>
        <stop offset="0.0001" stop-color="#F2F2F2"/>
        <stop offset="1" stop-color="#F2F2F2" stop-opacity="0"/>
      </radialGradient>
