  ...
  return (
    <Container>
      <LinkContainer href="https://twitter.com/LavaLampsNFT">
        <Icon icon={ICONS.TWITTER} iconColor='#FFFFFF' width={64} height={64} />
      </LinkContainer>
      <LinkContainer href="/opensea">
        <Icon icon={ICONS.OPENSEA} iconColor='#FFFFFF' width={64} height={64} />
      </LinkContainer>
      <LinkContainer href="https://discord.gg/kHjfv5t2Ns">
        <Icon icon={ICONS.DISCORD} iconColor='#FFFFFF' width={64} height={64} />
      </LinkContainer>
    </Container>
  );
}
